/*
Copyright © 2024 NAME HERE pdpreetidewani188@gmail.com
...
var rootCmd = &cobra.Command{
	...
	Long: `pscan - short for Port Scanner - executes TCP port scans on list of hosts.
...
func init() {
	...
	rootCmd.PersistentFlags().StringP("hosts-file", "f", "pscan.hosts", "File to store list of hosts")
